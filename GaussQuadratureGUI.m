function varargout = GaussQuadratureGUI(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GaussQuadratureGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @GaussQuadratureGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function GaussQuadratureGUI_OpeningFcn(hObject, eventdata, handles, varargin)

handles.output = hObject;

guidata(hObject, handles);

function varargout = GaussQuadratureGUI_OutputFcn(hObject, eventdata, handles) 
...
if(n<6 || n>6)
    f=msgbox('Lütfen n deðeri olarak 6 giriniz...');
else
...
vf=GaussQuad(f,startValue,finishValue,n);
vg=GaussQuad(g,startValue,finishValue,n);
