function varargout = ChebyshevQuadratureGUI(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ChebyshevQuadratureGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @ChebyshevQuadratureGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function ChebyshevQuadratureGUI_OpeningFcn(hObject, eventdata, handles, varargin)

handles.output = hObject;

guidata(hObject, handles);

function varargout = ChebyshevQuadratureGUI_OutputFcn(hObject, eventdata, handles) 
...
if(n>4 || n<4)
    f=msgbox('Lütfen n deðeri olarak 4 giriniz...');
else
...
vf=chebquad(f,n,startValue,finishValue);
vg=chebquad(g,n,startValue,finishValue);
