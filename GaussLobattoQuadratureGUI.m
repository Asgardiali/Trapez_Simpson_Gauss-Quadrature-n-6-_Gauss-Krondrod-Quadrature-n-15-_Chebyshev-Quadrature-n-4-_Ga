function varargout = GaussLobattoQuadratureGUI(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GaussLobattoQuadratureGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @GaussLobattoQuadratureGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function GaussLobattoQuadratureGUI_OpeningFcn(hObject, eventdata, handles, varargin)

handles.output = hObject;

guidata(hObject, handles);

function varargout = GaussLobattoQuadratureGUI_OutputFcn(hObject, eventdata, handles) 
...
if(n>5 || n<5)
    f=msgbox('Lütfen n deðeri olarak 5 giriniz...');
else
...
vf=GLGD_int(f,startValue,finishValue,n);
vg=GLGD_int(g,startValue,finishValue,n);
