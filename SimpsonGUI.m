function varargout = SimpsonGUI(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SimpsonGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @SimpsonGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function SimpsonGUI_OpeningFcn(hObject, eventdata, handles, varargin)

handles.output = hObject;

guidata(hObject, handles);

function varargout = SimpsonGUI_OutputFcn(hObject, eventdata, handles) 
...
vf=Simp(f,startValue,finishValue,n);
vg=Simp(g,startValue,finishValue,n);
